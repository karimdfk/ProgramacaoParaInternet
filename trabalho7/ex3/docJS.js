window.onload = function () {
    ...
    botoes = document.querySelectorAll("nav a");//Seleciona todos os button filhos de nav
    for (let i = 0; i < 4; i++) {//o for percorre todos os button armazenados em "botoes"
        botoes[i].addEventListener("click", mudaTab);//aciona a função mudaTab ao clickar em um botão
    }
